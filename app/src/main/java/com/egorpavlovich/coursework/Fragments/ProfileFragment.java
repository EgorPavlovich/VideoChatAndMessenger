...
public class ProfileFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        userGender = view.findViewById(R.id.profile_gender);

        drawerImage = drawerView.findViewById(R.id.drawer_imageView);
        drawerFullName = drawerView.findViewById(R.id.drawer_full_name);
        drawerEMail = drawerView.findViewById(R.id.drawer_email);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == IMAGE_REQUEST && resultCode == RESULT_OK
            ...
            if (uploadTask != null && uploadTask.isInProgress()){
                Toast.makeText(getContext(), "Загрузка в процессе выполнения", Toast.LENGTH_SHORT).show();
            } else {
                uploadImage();
            }
        }
